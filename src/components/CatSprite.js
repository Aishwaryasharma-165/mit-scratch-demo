...
export default function CatSprite() {
  ...
  return (
    ...
    <div>
      ...
      xmlSpace="preserve"
      style={{
        width:counterState.size.width,
        height:counterState.size.height,
        position:"relative",
        visibility:counterState.visibility,
        transform: `translate(${counterState.position.x}px, ${counterState.position.y}px) rotate(${counterState.rotation}deg)`
      }}
    >
      <g>
